...
public class ServiceController {
        ...
        public ResponseEntity<ApiResponse<ServiceResponse>> createService(
                        ...
                        @RequestParam(required = false) MultipartFile serviceImage,
                        @RequestParam(required = false) String description,
                        Principal principal) {
                ServiceRequest request = new ServiceRequest();
                request.setName(name);
                request.setPrice(price);
                request.setServiceImage(serviceImage);
        ...
        public ResponseEntity<ApiResponse<ServiceResponse>> updateService(
                ...
                ServiceResponse response = serviceService.updateService(serviceId, request, principal.getName(),
                                lastModifiedAt);
        ...
        public ResponseEntity<ApiResponse<Page<ServiceResponse>>> searchServices(
                ...
                Page<ServiceResponse> pageServices = new PageImpl<>(paginatedServices, PageRequest.of(page, safeSize),
                                services.size());
