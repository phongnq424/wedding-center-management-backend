...
public interface PaymentService {
    ...
    PaymentResponse updatePayment(UUID paymentId, PaymentUpdateRequest request, long lastModifiedAt, String currentUserId);

    PaymentResponse cancelPayment(UUID paymentId, String reason, String currentUserId);

    PaymentResponse processPayment(UUID paymentId, ProcessPaymentRequest request, String currentUserId);
