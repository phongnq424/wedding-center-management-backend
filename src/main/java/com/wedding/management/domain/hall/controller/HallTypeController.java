...
public class HallTypeController {
        ...
        public ResponseEntity<ApiResponse<HallTypeResponse>> createHallType(
                ...
                HallTypeResponse response = hallTypeService.createHallType(
                        request,
        ...
        public ResponseEntity<ApiResponse<HallTypeResponse>> updateHallType(
                ...
                HallTypeResponse response = hallTypeService.updateHallType(
                        hallTypeId,
                        request,
                        getCurrentUsername(principal),
                        lastModifiedAt
        ...
        public ResponseEntity<ApiResponse<Page<HallTypeResponse>>> searchHallTypes(
                ...
                List<HallTypeResponse> hallTypes = hallTypeService.searchHallTypes(
                        nameKeyword,
                        minBasePrice,
                        status
                );
                ...
                if (fromIndex >= hallTypes.size()) {
                        Page<HallTypeResponse> emptyPage = new PageImpl<>(
                                List.of(),
                ...
                Page<HallTypeResponse> pageHallTypes = new PageImpl<>(
                        paginatedHallTypes,
                        PageRequest.of(page, size),
                        hallTypes.size()
                );
        ...
        public ResponseEntity<ApiResponse<Void>> deleteHallType(
                ...
                hallTypeService.deleteHallType(
                        hallTypeId,
                        getCurrentUsername(principal)
                );
        ...
        public ResponseEntity<ApiResponse<HallTypeResponse>> getHallTypeById(
                @PathVariable UUID hallTypeId
        ) {
